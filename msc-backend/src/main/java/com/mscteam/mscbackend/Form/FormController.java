...
public class FormController {
    ...
    public FormRespondent getFormRespondentByUserId(@PathVariable("formId") String formId, @RequestBody HashMap<String, String> map){
    ...
    @PostMapping(path="/is-author-exist/{formId}")
